...
import 'package:flutter_sixvalley_ecommerce/view/screen/checkout/widget/car_type_widget.dart';
import 'package:flutter_sixvalley_ecommerce/view/screen/checkout/widget/custom_check_box.dart';
import 'package:flutter_sixvalley_ecommerce/view/screen/credit_card/credit_card_screen.dart';
...
class _CheckoutScreenState extends State<CheckoutScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    List<CreditCardModelCustom> _cards = Provider.of<AddCreditCardProvider>(
      context,
    ).cards;
    return Scaffold(
                                        ...
                                        CustomerInfo(
                                            ...
                                            _billingAddress
                                                ...
                                                : Provider.of<ProfileProvider>(context, listen: false)
                                                    ...
                                                    .id
                                                    .toString(),
                                            _billingAddress ? Provider.of<ProfileProvider>(context, listen: false).billingAddressList[Provider.of<OrderProvider>(context, listen: false).billingAddressIndex].address : Provider.of<ProfileProvider>(context, listen: false).addressList[Provider.of<OrderProvider>(context, listen: false).addressIndex].address,
                                            orderNote),
                                        _cartList,
                  ...
                  Container(
                    ...
                    child: Column(
                        ...
                        children: [
                          ...
                          CustomCheckBox(
                              onTap: () {
                                if (Provider.of<AddCreditCardProvider>(context,
                                            listen: false)
                                        .cards
                                        .length ==
                                    0) {
                              ...
                              title:
                                  getTranslated('label_credit_card', context),
                              index: 1),
                          Provider.of<AddCreditCardProvider>(
                                    context,
                                  ).cards.length >
                                  0
                              ? Expanded(
                                  child: ListView.builder(
                                      ...
                                      itemBuilder: (_, i) {
                                        return CardTypeWidget(
                                          id: _cards[i].id.toString(),
                                          index: i,
                                          number:
                                              _cards[i].cardNumber.toString(),
                                          onTap: () {},
                                          type: _cards[i].type.toString(),
                                        );
                                      }))
                              : const SizedBox(),
                          CustomCheckBox(
                              onTap: () {},
                              title: getTranslated('label_nequi', context),
                              index: 2),
                          CustomCheckBox(
                              onTap: () {},
                              title:
                                  getTranslated('label_bancolombia', context),
                              index: 3),
                          ...
                          Provider.of<AddCreditCardProvider>(
                                  ...
                                  0 && Provider.of<OrderProvider>(
                                    context,
                                  ).orderTypeIndex == 1
                              ? ListView.builder(
                                  itemCount: Provider.of<AddCreditCardProvider>(
                                          context)
                                      .cards
                                      .length,
                                  itemBuilder: (_, i) {
